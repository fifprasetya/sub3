package com.example.gittalk.receiver
...
class AlarmReceiver: BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        val intent = context.packageManager.getLaunchIntentForPackage("com.example.gittalk")
    ...
    fun setRepeatingAlarm(context: FragmentActivity?, type: String, time:String, message: String){
